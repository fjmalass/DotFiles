...
require("lazy").setup({
	...
	"NMAC427/guess-indent.nvim", -- Detect tabsop and shiftwidth automatically
	...
	{ -- LSP Configuration & Plugins
		...
		config = function()
			...
			-- Mason has bee setup earlier. no need
			-- require("mason").setup()
			...
			require("mason-lspconfig").setup({
				ensure_installed = {}, -- explicitly set  to an empyt table (kickstart populates install via mason-tool-installer)
