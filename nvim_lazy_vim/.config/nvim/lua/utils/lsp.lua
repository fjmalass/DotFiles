...
M.keys = function(bufnr)
	...
	keymap.set({ "n", "v" }, "<leader>ca", "<cmd>Lspsaga code_action<CR>", opt("Lsp: CodeAction"))
	...
	keymap.set("n", "<leader>wa", vim.lsp.buff.add_workspace_folder, opt("Lsp: AddWorkspaceFolder"))
	keymap.set("n", "<leader>wd", vim.lsp.buff.remove_workspace_folder, opt("Lsp: RemoveWorkspaceFolder"))
	keymap.set("n", "<leader>wl", function()
		print(vim.inspect(vim.lsp.buf.list_workspace_folder))
	end, opt("Lsp: ListWorkspaceFolder"))
