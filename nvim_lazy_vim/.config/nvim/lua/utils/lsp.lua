...
M.keys = function(bufnr)
	...
	keymap.set("n", "<leader>wa", vim.lsp.buf.add_workspace_folder, opt("Lsp: AddWorkspaceFolder"))
	keymap.set("n", "<leader>wd", vim.lsp.buf.remove_workspace_folder, opt("Lsp: RemoveWorkspaceFolder"))
