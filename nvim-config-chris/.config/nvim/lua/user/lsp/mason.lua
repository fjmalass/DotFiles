...
local settings = {
  ui = {
    border = "rounded",
    icons = {
      package_installed = icons.ui.italics.Check,
      package_pending = icons.ui.ArrowRight,
      package_uninstalled = icons.diagnostics.Error,
    },
  },
  log_level = vim.log.levels.INFO,
  max_concurrent_installers = 4,
  -- the directory where packages are installed (default: path.concat{vim.fn.stdpath "data", "mason"), i.e., ~/.local/share/nvim/
}
